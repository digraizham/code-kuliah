...
data_train = labelling.train2080
data_testing = labelling.train3070    
cl = NaiveBayesClassifier(data_train)   

data_test = remove_common(data_train, data_testing)

with open("For PPT/accuracy1.txt", "w", encoding='utf-8') as accuracy:
    print("Accuracy for 40 Data Train and 80 Data Test :", file=accuracy)
